...
var HeroHead = function (props) {
    var className = props.className, inputProps = __rest(props, ["className"]);
    var classNames = ClassNames([bulma_1.default.heroHead, className]);
    return (React.createElement("section", __assign({ className: classNames }, inputProps), props.children));
};
