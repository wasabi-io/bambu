...
var MessageBody = function (props) {
    ...
    var classNames = ClassNames(bulma_1.default.messageBody, className);
    return (React.createElement("div", __assign({ className: classNames }, ownProps), children));
};
MessageBody.propTypes = __assign({}, HTML_1.default.propTypes);
MessageBody.defaultProps = __assign({}, HTML_1.default.defaultProps);
