...
var PanelHeading = function (props) {
    var className = props.className, inputProps = __rest(props, ["className"]);
    var classNames = ClassNames([
        bulma_1.default.panelHeading,
        className
    ]);
    return (React.createElement("p", __assign({ className: classNames }, inputProps), props.children));
};
PanelHeading.propTypes = HTML_1.default.propTypes;
PanelHeading.defaultProps = HTML_1.default.defaultProps;
